---
description: Find and fix npm vulnerabilities in the project
---

Run a dependency security pass over the repo root. (Reelmint now lives in its own repository.)

1. `npm install && npm audit` at the repo root. Record every finding with severity and advisory link.
...
4. Finish with `npm audit` showing 0 vulnerabilities, or an explicit list of what remains and why it can't be fixed yet.
